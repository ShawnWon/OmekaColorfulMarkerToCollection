...
OmekaMapBrowse.prototype = {
    ...
    buildMarkerFromPlacemark: function (placeMark) {
        ...
        // Extract the collection info from the KML-formatted data
        var collection = placeMark.find('collection').text().replace(/(<([^>]+)>)/gi, "");
       ...
       //Build a customized icon
        ...
        this.addMarker([latitude, longitude], {title: title,icon:custIcon}, balloon);
    },
